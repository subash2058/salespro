...
class Common
{
    public function handle(Request $request, Closure $next)
    {
        ...
        $role_has_permissions_list = Cache::remember('role_has_permissions_list_'.Auth::user()->role_id, 60*60*24*365, function () {
        ...
        $categories_list = Cache::remember('categories_list', 60*60*24*365, function () {
            return DB::table('categories')->select('id','name')->where('is_active', true)->get();
        });
